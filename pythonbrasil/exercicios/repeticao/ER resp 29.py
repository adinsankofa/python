...
Você foi contratado para desenvolver o programa que monta esta tabela
de preços, que conterá os preços de 1 até 50 produtos, conforme o exemplo
abaixo:
...
for i in range(1,50+1):
    if i < 10:
        print('0%i = R$ %0.2f'%(i,1.99 * i))
    else:
        print('%i = R$ %0.2f'%(i,1.99 * i))
